...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('vegancity_userprofile', (
            ...
            ('karma_points', self.gf('django.db.models.fields.IntegerField')
        ...
        db.create_table('vegancity_vegandish', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, null=True, blank=True)),
            ('vendor', self.gf('django.db.models.fields.related.ForeignKey')
             (to=orm['vegancity.Vendor'])),
        ))
        ...
        db.create_table('vegancity_review', (
            ...
            ('food_rating', self.gf('django.db.models.fields.IntegerField')
             (null=True, blank=True)),
            ('atmosphere_rating', self.gf('django.db.models.fields.IntegerField')
             (null=True, blank=True)),
            ('best_vegan_dish', self.gf('django.db.models.fields.related.ForeignKey')
             (to=orm['vegancity.VeganDish'], null=True, blank=True)),
            ('unlisted_vegan_dish', self.gf('django.db.models.fields.CharField')
             (max_length=100, null=True, blank=True)),
            ('suggested_feature_tags', self.gf('django.db.models.fields.CharField')
             (max_length=255, null=True, blank=True)),
            ('suggested_cuisine_tags', self.gf('django.db.models.fields.CharField')
             (max_length=255, null=True, blank=True)),
        ...
        db.create_table('vegancity_vendor', (
            ...
            ('neighborhood', self.gf('django.db.models.fields.related.ForeignKey')
             (to=orm['vegancity.Neighborhood'], null=True, blank=True)),
            ...
            ('notes', self.gf('django.db.models.fields.TextField')
             (null=True, blank=True)),
            ('veg_level', self.gf('django.db.models.fields.related.ForeignKey')
             (to=orm['vegancity.VegLevel'], null=True, blank=True)),
        ))
        ...
        db.create_table('vegancity_vendor_cuisine_tags', (
            ...
            ('cuisinetag', models.ForeignKey(
                orm['vegancity.cuisinetag'], null=False))
        ))
        db.create_unique(
            'vegancity_vendor_cuisine_tags', ['vendor_id', 'cuisinetag_id'])

        # Adding M2M table for field feature_tags on 'Vendor'
        db.create_table('vegancity_vendor_feature_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vendor', models.ForeignKey(orm['vegancity.vendor'], null=False)),
            ('featuretag', models.ForeignKey(
                orm['vegancity.featuretag'], null=False))
        ))
        db.create_unique(
            'vegancity_vendor_feature_tags', ['vendor_id', 'featuretag_id'])
