...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Review', fields ['approved']
        db.create_index(u'vegancity_review', ['approved'])

        # Adding index on 'Vendor', fields ['name']
        db.create_index(u'vegancity_vendor', ['name'])

        # Adding index on 'Vendor', fields ['approval_status']
        db.create_index(u'vegancity_vendor', ['approval_status'])


    def backwards(self, orm):
        # Removing index on 'Vendor', fields ['approval_status']
        db.delete_index(u'vegancity_vendor', ['approval_status'])

        # Removing index on 'Vendor', fields ['name']
        db.delete_index(u'vegancity_vendor', ['name'])

        # Removing index on 'Review', fields ['approved']
        db.delete_index(u'vegancity_review', ['approved'])
