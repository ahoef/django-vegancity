...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        all_dishes = orm.VeganDish.objects.all()
        for vendor in orm.Vendor.objects.all():
            matched_dishes = all_dishes.filter(vendor=vendor.id)
            for dish in matched_dishes:
                vendor.vegan_dishes.add(dish)

    def backwards(self, orm):
        for vendor in orm.Vendor.objects.all():
            vendor.vegan_dishes.clear()
    ...
    models = {
        ...
        'vegancity.vendor': {
            ...
            'approval_status': ('django.db.models.fields.CharField', [], {'default': "'pending'", 'max_length': '100'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'vegan_dishes': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'vendor_vegan_dishes'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['vegancity.VeganDish']"}),
