...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        ...
        for vendor in orm.Vendor.objects.all():
            if vendor.approval_status == "approved":
                ...
                # any vendors in any categor besides "approved"
                # will have to be marked as unapproved. Even if
                # the natural coercion would be to approved=True
                # like in some imagined case of approval_status=
                # 'encouraged', we won't be inclined to change
    ...
    models = {
        ...
        'vegancity.vendor': {
            ...
            'approval_status': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
